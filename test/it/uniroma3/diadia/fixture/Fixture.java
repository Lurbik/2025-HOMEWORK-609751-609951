...
public class Fixture {
	public static IOSimulator creaSimulazionePartitaEGioca2(List<String> comandiDaLeggere) throws Exception {
	...
	public static IOSimulator creaSimulazionePartitaEGioca4(List<String> comandiDaLeggere) throws Exception {
		IOSimulator io = new IOSimulator(comandiDaLeggere);
